...
using Oceananigans.Models.HydrostaticFreeSurfaceModels: mask_immersed_model_fields!, diffusivity_kernel_parameters, update_vertical_velocities!, compute_momentum_tendencies!,
                                                        ...
                                                        explicit_barotropic_pressure_y_gradient, grid_slope_contribution_y, hydrostatic_fields
...
@kernel function my_compute_hydrostatic_free_surface_Gv!(Gv, grid, args)
    i, j, k = @index(Global, NTuple)
    @inbounds Gv[i, j, k] = my_hydrostatic_free_surface_v_velocity_tendency(i, j, k, grid, args...)
end
